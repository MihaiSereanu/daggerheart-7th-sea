...
export class CompanionActorSheet extends SimpleActorSheet {
  ...
  static get defaultOptions() {
    ...
    return foundry.utils.mergeObject(super.defaultOptions, {
      classes: ["daggerheart-7th-sea", "sheet", "companion"],
      template:
        "systems/daggerheart-7th-sea/templates/actor-sheet-companion.html",
      width: width,
      height: height,
      tabs: [
        {
  ...
  async getData(options) {
    ...
    context.isOutOfScene =
      stress && stress.value === stress.max && stress.max > 0;
